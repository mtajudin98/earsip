                ...
                <tr>
                    ...
                    <td class="align-middle">
                        <div class="btn-group" role="group" aria-label="Basic example">
                            <a href="{{ route('kantorinduk.show', $rs->id)}}" class="btn btn-secondary" type="button">Detail</a>
                            <a href="{{ route('kantorinduk.edit', $rs->id)}}" class="btn btn-warning" type="button">Edit</a>
                            <form action="{{ route('kantorinduk.destroy', $rs->id)}}" method="POST" type="button" class="btn btn-danger">
                            @csrf
                            @method('DELETE')
