...
<hr>
    <div class="form-group">
            ...
            <input value="{{ $unitkerja->kode_induk }}" name="kode_induk" type="text" class="form-control form-control-user" id="Name">
    </div>
    <div class="form-group">
        <input type="text" value="{{ $unitkerja->nama_induk }}" name="nama_induk" class="form-control form-control-user" id="exampleInputEmail"
